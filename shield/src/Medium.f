...
C     *         5X,'K-     K+',2X)
C          DO K=1,60
C            WRITE(26,12) IFIX(ENET(K)),(SIGMAC(K,L,J),L=1,8)
...
C     *        16X)
c          DO K=1,60
C            WRITE(26,14) IFIX(ENET(K)),(SIGMAC(K,L,J),L=9,14)
...
C
c       DO K=1,100
c         WRITE(26,140) TR(K),RANMAC(K,1,J),OPTMAC(K,1,J),
...
C
c       DO K=1,100
c         WRITE(26,140) TR(K),RANMAC(K,5,J),OPTMAC(K,5,J),
...
C
c       DO K=1,100
c         WRITE(26,140) TR(K),RANMAC(K, 9,J),OPTMAC(K, 9,J),
