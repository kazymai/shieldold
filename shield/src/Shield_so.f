...
C
c      IF(PARLEV( 1) .ne. DFLT( 1)) WRITE(24, 1) 1,PARLEV( 1)
c      IF(PARLEV( 2) .ne. DFLT( 2)) WRITE(24, 2) 2,PARLEV( 2)
c      IF(PARLEV( 3) .ne. DFLT( 3)) WRITE(24, 3) 3,PARLEV( 3)
c      IF(PARLEV( 4) .ne. DFLT( 4)) WRITE(24, 4) 4,PARLEV( 4)
c      IF(PARLEV( 5) .ne. DFLT( 5)) WRITE(24, 5) 5,PARLEV( 5)
c      IF(PARLEV( 6) .ne. DFLT( 6)) WRITE(24, 6) 6,PARLEV( 6)
c      IF(PARLEV( 7) .ne. DFLT( 7)) WRITE(24, 7) 7,PARLEV( 7)
c      IF(PARLEV( 8) .ne. DFLT( 8)) WRITE(24, 8) 8,PARLEV( 8)
c      IF(PARLEV( 9) .ne. DFLT( 9)) WRITE(24, 9) 9,PARLEV( 9)
c      IF(PARLEV(10) .ne. DFLT(10)) WRITE(24,10)10,PARLEV(10)
c      IF(PARLEV(11) .ne. DFLT(11)) WRITE(24,11)11,PARLEV(11)
c      IF(PARLEV(12) .ne. DFLT(12)) WRITE(24,12)12,PARLEV(12)
c      IF(PARLEV(13) .ne. DFLT(13)) WRITE(24,13)13,PARLEV(13)
c      IF(PARLEV(14) .ne. DFLT(14)) WRITE(24,14)14,PARLEV(14)
c      IF(PARLEV(15) .ne. DFLT(15)) WRITE(24,15)15,PARLEV(15)
c      IF(PARLEV(16) .ne. DFLT(16)) WRITE(24,16)16,PARLEV(16)
c      IF(PARLEV(17) .ne. DFLT(17)) WRITE(24,17)17,PARLEV(17)
c      IF(PARLEV(18) .ne. DFLT(18)) WRITE(24,18)18,PARLEV(18)
c      IF(PARLEV(19) .ne. DFLT(19)) WRITE(24,19)19,PARLEV(19)
c      IF(PARLEV(20) .ne. DFLT(20)) WRITE(24,20)20,PARLEV(20)
c      IF(PARLEV(21) .ne. DFLT(21)) WRITE(24,21)21,PARLEV(21)
C
c      IF(PARLEV(22) .ne. DFLT(22)) WRITE(24,22)22,PARLEV(22)
C
c      IF(PARLEV(23) .ne. DFLT(23)) WRITE(24,23)23,INT(PARLEV(23))
c      IF(PARLEV(24) .ne. DFLT(24)) WRITE(24,24)24,INT(PARLEV(24))
c      IF(PARLEV(25) .ne. DFLT(25)) WRITE(24,25)25,PARLEV(25)
c      IF(PARLEV(26) .ne. DFLT(26)) WRITE(24,26)26,PARLEV(26)
c      IF(PARLEV(27) .ne. DFLT(27)) WRITE(24,27)27,PARLEV(27)
c      IF(PARLEV(28) .ne. DFLT(28)) WRITE(24,28)28,PARLEV(28)
c      IF(PARLEV(29) .ne. DFLT(29)) WRITE(24,29)29,PARLEV(29)
c      IF(PARLEV(30) .ne. DFLT(30)) WRITE(24,30)30,PARLEV(30)
c      IF(PARLEV(31) .ne. DFLT(31)) WRITE(24,31)31,PARLEV(31)
c      IF(PARLEV(32) .ne. DFLT(32)) WRITE(24,32)32,INT(PARLEV(32))   ! DKFZg
c      IF(PARLEV(33) .ne. DFLT(33)) WRITE(24,33)33,PARLEV(33)   ! DKFZg
c      IF(PARLEV(34) .ne. DFLT(34)) WRITE(24,34)34,PARLEV(34)   ! DKFZg
Cc
c      IF(PARLEV(39) .ne. DFLT(39)) WRITE(24,39)39,PARLEV(39)   ! DKFZf
c      IF(PARLEV(40) .ne. DFLT(40)) WRITE(24,40)40,PARLEV(40)   ! DKFZf
Cc
