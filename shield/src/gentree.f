...
C
      WRITE(25,1001)KSTATE,IXINIT,NUMTRE
...
C
     ...
     *   NANUM .GE.L20100)THEN
	  WRITE(25,1001)IXINIT,NUMTRE,LINE2,NNEUTR,NGAMMA,
     *                  NEMIN,NEPLS,NNUEL,NANUE,NNUMU,NANUM
...
*&      write(25,1)NUCFIR,NUCLAS,NPRFIR,NPRLAS,KSECNU
...
*&        write(25,3)K,(ITREE(I,K),I=1,7),TREE(7,K)
*&        write(25,3)L,(ITREE(I,L),I=1,7),TREE(7,L)
*&C
...
*&        END IF
*&C       .............................................
*&        write(25,2)J,(ITREE(I,J),I=1,7),TREE(4,J),TREE(5,J),EA
*&    2   format(I6,7I4,5X,2F5.1,F12.4)
*&      end do
*&C
*&      do J=NPRFIR,NPRLAS        ! Secondary CASCADE particles (NO n<14.5!)
*&        write(25,3)J,(ITREE(I,J),I=1,7),TREE(7,J)
...
C Check if this is nucleus or not?
 ...
 1000     FORMAT(' NUCPAR DIAGNOSTIC: This is not a nucleus.')
          WRITE(25,1001)(ITREE(I,J),I=1,7)
 1001     FORMAT(6X,7I4)
          WRITE(25,1002)(TREE(I,J),I=1,7)
 1002     FORMAT(7F10.2)
c          STOP
        END IF
      END DO
...
*&          END IF
*&C         .............................................
*&          write(25,102)J,(ITREE(I,J),I=1,7),TREE(4,J),TREE(5,J),EA
*&  102     format(I6,7I4,5X,2F5.1,F12.4)
*&        ELSE
*&          write(25,104)J,(ITREE(I,J),I=1,7),TREE(7,J),
*&     *                    TREE(14,J),TREE(15,J)
...
*&C
*&      do J=NPRFIR,NPRLAS        ! Secondary CASCADE particles (NO n<14.5!)
*&        write(25,103)J,(ITREE(I,J),I=1,7),TREE(7,J)
...
*&          END IF
*&C         .............................................
*&          write(25,202)J,(ITREE(I,J),I=1,7),TREE(4,J),TREE(5,J),EA
*&  202     format(I6,7I4,5X,2F5.1,F12.4)
*&        ELSE
*&          write(25,204)J,(ITREE(I,J),I=1,7),TREE(7,J),
*&     *                    TREE(14,J),TREE(15,J)
...
*&     *                      TREE(14,J),TREE(15,J)
*&          else
*&            write(25,203)J,(ITREE(I,J),I=1,7),TREE(7,J)
...
C
   12 CALL MICROD(JPART,TINT*APART,NUCLID,SIGTOT,SIGIN)
	  IF(RAN(IX).LE.SIGIN/SIGTOT)THEN
	      KSTATE=2
	  ELSE
	      KSTATE=1
	  END IF
