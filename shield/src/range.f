...
c      write(25,754)IWP(1),WP(7),WP(9)                           !HIONDEB
...
c      write(25,755)NEXTZ,S                                     !HIONDEB
...
C         (as result we have: R, TF, KSTATE=0 or 3)
      ELSE
cC                                                                    !HIONDEB
c          write(25,7654)GAMMA,JPART,TI,TF,R,S,KSTATE                 !HIONDEB
...
cC                                                                    !HIONDEB
c          write(25,7655)GAMMA,JPART,TI,TF,R,S,KSTATE                 !HIONDEB
...
C
C-----------------------------DIAGNOSTIC------------------------------------
 1000 WRITE(25,1001)JPART,NTREE
